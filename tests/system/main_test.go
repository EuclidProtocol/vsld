...
func TestMain(m *testing.M) {
	...
	execBinary := flag.String("binary", "lumend", "executable binary for server/ client side")
	bech32Prefix := flag.String("bech32", "euclid", "bech32 prefix to be used with addresses")
